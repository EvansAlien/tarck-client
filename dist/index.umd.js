(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = { Track: factory() }) : typeof define === 'function' && define.amd ? define(factory) : (global.Track = factory());
})(this, function () {
		...
		z.prototype = {
			...
			watchNetworkObject: function (a) {
				...
				a.prototype.send = function () {
					...
					try {
						(this._trackJs.logId = b.log.add('n', { type: 'xhr', startedOn: b.util.isoNow(), method: this._trackJs.method, url: c.truncate(this._trackJs.url, 2e3) })),
					...
					if (this.hasInstalled && this.hasEnabled && c.isBrowserSupported())
						try {
							if (
								...
								(e && c.isError(e)) || (e = { name: 'Error', message: this.serialize(e, f.force) }),
								-1 === e.message.indexOf('Track Caught'))
							)
